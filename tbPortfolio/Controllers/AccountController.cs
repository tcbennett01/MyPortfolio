...
namespace tbPortfolio.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    return RedirectToLocal(@Url.Action("Index", "BlogPosts"));
        ...
        public async Task<ActionResult> ResendEmailConfirmation(ForgotPasswordViewModel model)
        {
            ...
            return RedirectToAction("ConfirmatinSent");
        }
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // Strip off email domain - loading mailbox as DisPlayName
                //String userEmail = model.Email;
                //Char delimiter = '@';
                //String[] emailParts = userEmail.Split(delimiter);
